...
class MAX3010x {
public:
	MAX3010x(I2C_HandleTypeDef* hI2c) : mI2c(hI2c) {}
	HAL_StatusTypeDef init(void);
	void setup(uint8_t powerLevel, uint8_t sampleAverage, uint8_t ledMode, uint16_t sampleRate, uint16_t pulseWidth, uint16_t adcRange);
